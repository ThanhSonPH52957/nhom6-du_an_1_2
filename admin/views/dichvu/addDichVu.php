      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?= BASE_URL_ADMIN . '?act=insertdichvu'?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Tên dịch vụ</label>
                    <input type="text" class="form-control" name="ten_dich_vu" placeholder="Nhập tên dịch vụ">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="gia_dich_vu" placeholder="Nhập giá dịch vụ">
